sap.ui.define([
	...
	return Object.extend("com.flexso.htf2022.service.CoreService", {
		constructor: function (model) {
			Object.call(this);
			if (model) {
				// this.setModel(model);
				Array.isArray(model) ? this.setModels(model) : this.setModel(model);
			}
		},
		...
		setModels: function (aModels) {
			this.models = aModels.reduce(function (oResult, oModel) {
				oResult[this.getModelName(oModel.sServiceUrl)] = oModel;
				return oResult;
			}.bind(this), {});
		},
		getModelName: function (sModelName) {
			return sModelName.substr(sModelName.lastIndexOf(":") + 1);
		},
		odata: function (thingtype, url) {
			...
			var core = {
				ajax: function (type, url, data, parameters) {
					var promise = new Promise(function (resolve, reject) {
						...
						args.push(params);
						me.models[me.getModelName(thingtype)][type].apply(me.models[me.getModelName(thingtype)], args);
